...
class AppCalculadora():
    def __init__(self, root):
        ...
        self.txtEntrada = tk.Entry(root).grid(column=3, row=0, sticky="W")
        ...
        self.btnCI = tk.Button( text="CI", command= lambda: self.write("C1"), height = 1, width = 5)
        self.btnCI.grid(column=1, row=8)
        self.btnCE = tk.Button( text="CE", command= lambda: self.write("C1"), height = 1, width = 5)
        self.btnCE.grid(column=2, row=8)

        #OPERADORES
        self.btnDiv = tk.Button( text="/", command= lambda: self.write("/"), height = 1, width = 5)
        self.btnDiv.grid(column=4, row=2)
        self.btnMult = tk.Button( text="*", command= lambda: self.write("*"), height = 1, width = 5)
        self.btnMult.grid(column=4, row=3)
        self.btnResta = tk.Button( text="-", command= lambda: self.write("-"), height = 1, width = 5)
        self.btnResta.grid(column=4, row=4)
        self.btnSuma = tk.Button( text="+", command= lambda: self.write("+"), height = 1, width = 5)
        self.btnSuma.grid(column=4, row=5)
        self.btnIgual = tk.Button( text="=", command= lambda: self.write("="), height = 1, width = 5)
